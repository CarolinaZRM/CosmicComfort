...
exports.createUser = async (req, res) => {
    ...
    try {
        ...
        const requiredFields = ['username', 'email', 'password', 'profilePicture']
...
exports.updateProfilePicture = async (req, res) => {
    ...
    console.log("profile picture req.body:", profilePicture);
    ...
    try {
        ...
        console.log("profile picture after try:", profilePicture)
    } catch (error) {
